 ...
 */
class IndexImgDto extends Model
{
    ...
    public function rules():array
    {
        return [
            ...
            [['name', 'stylist','audit_status','upload_time','size'], 'string', 'on' => self::SEARCH],
            [['beginTime', 'endTime'], 'integer','on' => self::SEARCH],
            [['version', 'name', 'stylist', 'picture_address','size'], 'string', 'on' => self::EDIT],
