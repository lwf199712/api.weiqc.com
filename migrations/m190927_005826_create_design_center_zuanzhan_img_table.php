...
/**
 * Handles the creation of table `{{%design_center_zuanzhan_img}}`.
 */
class m190927_005826_create_design_center_zuanzhan_img_table extends Migration
{
    public $tableName = '{{%design_center_zuanzhan_img}}';
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->dropTable('{{%design_center_zuanzhan_img}}');
    }
}
