...
/**
 * Handles the creation of table `{{%design_center_product_detail_img}}`.
 */
class m190927_052205_create_design_center_product_detail_img_table extends Migration
{
    public $tableName = '{{%design_center_product_detail_img}}';
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->dropTable('{{%design_center_product_detail_img}}');
    }
}
