...
/**
 * Handles the creation of table `{{%design_center_Landingpage_img}}`.
 */
class m190927_013356_create_design_center_Landingpage_img_table extends Migration
{
    public $tableName = '{{%design_center_landingpage_img}}';
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->dropTable('{{%design_center_Landingpage_img}}');
    }
}
