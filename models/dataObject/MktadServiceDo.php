 ...
 *
 * @property int    $id
 * @property string $service     服务号,如club、family
 * @property int    $is_delete   是否删除，0/未删除、1/已删除
 * @property string $creater     创建人
 * @property int    $create_time 创建时间
 * @property string $update_user 修改人
 * @property int    $update_time 修改时间
 * @property int    $parent      服务号父级id
 */
class MktadServiceDo extends ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['is_delete', 'create_time', 'update_time', 'parent'], 'integer'],
            [['service', 'creater', 'update_user'], 'string', 'max' => 32],
        ];
    }
